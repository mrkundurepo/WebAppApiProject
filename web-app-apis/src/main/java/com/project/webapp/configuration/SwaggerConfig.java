package com.project.webapp.configuration;
...
public class SwaggerConfig {
	...
	private ApiInfo getInfo() {
		return new ApiInfo("Web Application: Backend", 
				"This API is designed to serve web users.", "1.0", "Terms of Service", DEFAULT_CONTACT,
				"", "", new ArrayList<>());
	}
}
