...
public class JwtTokenHelper {
	...
	// According to JWS compact serialization (https://tools.ietf.org/html/draft-ietf-jose-web-signature-41#section-3.1)
	// compaction of the JWT to a URL-sage string
